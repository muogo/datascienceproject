...
import numpy as np
import joblib
from src.datascienca.entity.config_entity import ModelEvaluationConfig
    ...
    def log_into_mlflow(self):
        ...
        with mlflow.start_run():
            ...
            if tracking_url_type_store != "file":
                ...
                # Daftarkan model
                # Ada cara lain untuk menggunakan Model Registry, yang bergantung pada kasus penggunaan,
                # silakan rujuk dokumen untuk informasi lebih lanjut:
